...
type AudienceType = "all" | "active" | "guests" | "specific";
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  { id: "active" as AudienceType, label: "المسجلون النشطون", icon: "/assets/dashboard/activity.svg" },
                  { id: "guests" as AudienceType, label: "الزوار", icon: "/assets/dashboard/profile-2user.svg" },
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-[12px] text-[#64748b]">
                    ...
                    <span>{log.recipientCount} جهاز مستهدف</span>
                  </div>
                </div>
              );
            })}
