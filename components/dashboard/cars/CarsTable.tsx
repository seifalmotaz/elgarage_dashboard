      ...
      <div className="flex items-center justify-center gap-1">
        {onToggleFeatured && (
          <button
            ...
            title={row.isFeatured ? "إزالة من المميزة" : "إضافة للمميزة"}
            aria-label={row.isFeatured ? "إزالة من المميزة" : "إضافة للمميزة"}
          ...
          >
            <svg
              ...
              height="20"
              viewBox="0 0 24 24"
              fill={row.isFeatured ? "#FFD700" : "none"}
              stroke={row.isFeatured ? "#FFD700" : "#9CA3AF"}
              strokeWidth="2"
            >
...
export default function CarsTable({
  ...
  const columns = createColumns(onEdit, onDelete, onView, onToggleFeatured);
