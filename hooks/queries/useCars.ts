 ...
 */
export function useCars(filters?: CarFilters, enabled = true) {
  return useQuery({
...
/**
 * Get every page of a car listing progressively for the grid view.
 */
export function useInfiniteCars(
  ...
  return useInfiniteQuery({
    queryKey: queryKeys.cars.infiniteList(filters as Record<string, unknown>),
    queryFn: ({ pageParam }) => carsApi.getList({ ...filters, page: pageParam, limit }),
    initialPageParam: 1,
